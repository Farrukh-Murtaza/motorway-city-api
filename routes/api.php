...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('customers/get_data', [CustomerController::class , 'fieldData']);
    Route::apiResource('customers', CustomerController::class)->only(['index', 'show', 'update', 'store', 'destroy']);
    ...
    Route::get('plots/status/available', [PlotController::class, 'availablePlots']);
    Route::patch('plots/{plot}/status', [PlotController::class, 'updateStatus']);
    Route::get('plots/statistics/summary', [PlotController::class, 'statistics']);
    ...
    Route::get('payments/plot-sale/{plotSaleId}', [PaymentController::class, 'getPlotSalePayments']);
